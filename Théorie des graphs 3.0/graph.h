...
class Graph
{
    ...
    public:
        ...
        void charger_graphe(std::string btp);
        void new_graph(std::string img);
        void update_graph(std::string btp);
        //void update_arc(std::string btp);
        void creation();
        void supprimer_arrete(int eidx);
        void supprimer_sommet();
        void ajouter_sommet();
        void ajouter_arrete();
        void supprimer_arrete_choix();
