...
void Graph::make_example()
{
    ...
    if(fichier2)
    {
        ...
        for(int i=0; i<5; i++)
        {
            //Lecture des indices de sommets de chaque arete à partir du fichier, puis affectation dans le tableau
            //D'aretes du graphe
    ...
    std::string arc = "arc.txt";
    std::ifstream fichier(arc);
...
/*void Graph::update_arc()
{
    std::string image = "arc.txt";
    std::ofstream fichier(image);
